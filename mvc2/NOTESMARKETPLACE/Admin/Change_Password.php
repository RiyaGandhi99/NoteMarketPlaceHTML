                    ...
                    <form action="" method="post" name="Change_Password_Form" onsubmit="return validateForm()">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="form-group text-left">
                                ...
                                <input type="password" name="Old_Password" value="<?php if(isset($_SESSION['loggedin'])){ echo $OldPassword; }else{ echo ""; } ?>" class="form-control" placeholder="Enter your old password" id="password-field1" required>
                                <div class="input-group-append">
                                     <span toggle="#password-field1" class="eye field-icon toggle-password"><img src="images/pre-login/eye.png" alt="eye"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="form-group text-left">
                                ...
                                <div class="input-group-append">
                                     <span toggle="#password-field2" class="eye field-icon toggle-password"><img src="images/pre-login/eye.png" alt="eye"></span>
                                </div>
                            </div>
                        </div>

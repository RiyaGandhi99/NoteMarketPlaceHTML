                        ...
                        <div class="form-group text-left">
                            ...
                            <?php 
                                ...
                                if(isset($_GET['UserID'])){
                                    ...
                                    /*  To fetch specific Download Note (Redirect From Member Page)*/  
                                    $query = "SELECT DISTINCT NoteTitle FROM downloads WHERE NoteID=$UID AND IsAttachmentDownloaded=1 AND IsActive=1 ORDER BY AttachmentDownloadedDate DESC";
                                }else{
                        ...
                        <div class="form-group text-left">
                            ...
                            <?php 
                                if(isset($_GET['UserID'])){
                                    ...
                                    /*  To fetch specific Download Note (Redirect From Member Page)*/  
                                    $query = "SELECT DISTINCT Seller FROM downloads WHERE NoteID=$UID AND IsAttachmentDownloaded=1 AND IsActive=1 ORDER BY AttachmentDownloadedDate DESC";
                                }else{
                        ...
                        <div class="form-group text-left">
                            ...
                            <?php   
                                ...
                                if(isset($_GET['UserID'])){
                                    ...
                                    /*  To fetch specific Download Note (Redirect From Member Page)*/  
                                    $query = "SELECT DISTINCT Downloader FROM downloads WHERE NoteID=$UID AND IsAttachmentDownloaded=1 AND IsActive=1 ORDER BY AttachmentDownloadedDate DESC";
                                }else{
